...
export const day11Session = async ({
    whatsappPhone,
    name,
    userId
}) => {

    console.log("recvied user data day 11 morning trigger: ", whatsappPhone, name, userId)
    try {
        ...
        const payload = {
            ...
            templateParams: [
                `${name} Ji ☀️`,
                "🎯 Focus",
                "*Muscle Endurance & Postural Strength*"
            ],
...
export const day11SessionEvening = async ({
    whatsappPhone,
    name,
    userId
}) => {

    console.log("recvied user day 11 evening data : ", whatsappPhone, name, userId)
    try {
