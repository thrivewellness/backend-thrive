...
export const day12Session = async ({
    whatsappPhone,
    name,
    userId
}) => {

    console.log("recvied user data day 12 morning trigger: ", whatsappPhone, name, userId)
    try {
...
export const day12SessionEvening = async ({
    whatsappPhone,
    name,
    userId
}) => {

    console.log("recvied user day 12 evening data : ", whatsappPhone, name, userId)
    try {
