...
export const day9Session = async ({
    whatsappPhone,
    name,
    userId
}) => {

    console.log("recvied user data day 9 morning trigger: ", whatsappPhone, name, userId)
    try {
...
export const day9SessionEvening = async ({
    whatsappPhone,
    name,
    userId
}) => {

    console.log("recvied user day 9 evening data : ", whatsappPhone, name, userId)
    try {
